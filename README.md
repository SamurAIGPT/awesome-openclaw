...
- [Ariadne Loop](https://github.com/zhangzeyu99-web/ariadne-loop/tree/main/skills/ariadne-loop) - Verifiable loop-engineering skill for OpenClaw, Codex, and Claude Code: define loop specs, gates, JSON reports, and handoff packets for repeatable agent work.
